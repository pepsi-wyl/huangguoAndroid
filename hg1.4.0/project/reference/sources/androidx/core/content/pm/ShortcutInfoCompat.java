...
public class ShortcutInfoCompat {
    ...
    public ShortcutInfo toShortcutInfo() {
        ComponentDialog$$ExternalSyntheticApiModelOutline0.m22m();
        ShortcutInfo.Builder intents = ComponentDialog$$ExternalSyntheticApiModelOutline0.m12m(this.mContext, this.mId).setShortLabel(this.mLabel).setIntents(this.mIntents);
    ...
    static List<ShortcutInfoCompat> fromShortcuts(Context context, List<ShortcutInfo> list) {
        ...
        while (it.hasNext()) {
            arrayList.add(new Builder(context, ComponentDialog$$ExternalSyntheticApiModelOutline0.m13m((Object) it.next())).build());
        }
        return arrayList;
    }
