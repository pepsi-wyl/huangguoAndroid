...
public class PrecomputedTextCompat implements Spannable {
    ...
    public static final class Params {
        ...
        Params(TextPaint textPaint, TextDirectionHeuristic textDirectionHeuristic, int i, int i2) {
            if (Build.VERSION.SDK_INT >= 29) {
                this.mWrapped = Insets$$ExternalSyntheticApiModelOutline0.m57m(textPaint).setBreakStrategy(i).setHyphenationFrequency(i2).setTextDirection(textDirectionHeuristic).build();
            } else {
                this.mWrapped = null;
            }
            this.mPaint = textPaint;
    ...
    public PrecomputedText getPrecomputedText() {
        if (Insets$$ExternalSyntheticApiModelOutline0.m69m((Object) this.mText)) {
            return Insets$$ExternalSyntheticApiModelOutline0.m58m((Object) this.mText);
        }
        return null;
    }
