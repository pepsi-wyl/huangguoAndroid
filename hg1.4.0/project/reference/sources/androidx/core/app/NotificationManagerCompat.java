...
public final class NotificationManagerCompat {
    ...
    public void deleteUnlistedNotificationChannels(Collection<String> collection) {
        if (Build.VERSION.SDK_INT >= 26) {
            ...
            while (it.hasNext()) {
                NotificationChannel notificationChannelM7m = ComponentDialog$$ExternalSyntheticApiModelOutline0.m7m((Object) it.next());
                if (!collection.contains(Api26Impl.getId(notificationChannelM7m)) && (Build.VERSION.SDK_INT < 30 || !collection.contains(Api30Impl.getParentChannelId(notificationChannelM7m)))) {
                    Api26Impl.deleteNotificationChannel(this.mNotificationManager, Api26Impl.getId(notificationChannelM7m));
                }
            }
        }
    }
    ...
    public NotificationChannelGroup getNotificationChannelGroup(String str) {
        ...
        if (Build.VERSION.SDK_INT >= 26) {
            ...
            while (it.hasNext()) {
                NotificationChannelGroup notificationChannelGroupM8m = ComponentDialog$$ExternalSyntheticApiModelOutline0.m8m((Object) it.next());
                if (Api26Impl.getId(notificationChannelGroupM8m).equals(str)) {
                    return notificationChannelGroupM8m;
                }
            }
        }
        return null;
    ...
    public List<NotificationChannelCompat> getNotificationChannelsCompat() {
        if (Build.VERSION.SDK_INT >= 26) {
            ...
            if (!notificationChannels.isEmpty()) {
                ...
                while (it.hasNext()) {
                    arrayList.add(new NotificationChannelCompat(ComponentDialog$$ExternalSyntheticApiModelOutline0.m7m((Object) it.next())));
                }
                return arrayList;
            }
        }
        ...
        if (Build.VERSION.SDK_INT >= 26) {
            ...
            if (!notificationChannelGroups.isEmpty()) {
                ...
                while (it.hasNext()) {
                    NotificationChannelGroup notificationChannelGroupM8m = ComponentDialog$$ExternalSyntheticApiModelOutline0.m8m((Object) it.next());
                    if (Build.VERSION.SDK_INT >= 28) {
                        arrayList.add(new NotificationChannelGroupCompat(notificationChannelGroupM8m));
                    } else {
                        arrayList.add(new NotificationChannelGroupCompat(notificationChannelGroupM8m, notificationChannels));
                    }
                }
                return arrayList;
            }
