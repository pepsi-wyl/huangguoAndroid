...
final class FragmentManagerImpl extends FragmentManager implements LayoutInflater.Factory2 {
    ...
    */
    void moveToState(Fragment fragment, int i, int i2, int i3, boolean z) throws Resources.NotFoundException {
        int i4;
        int iMin;
        Fragment fragment2;
        String str;
        ...
        if (fragment.mMaxState == Lifecycle.State.CREATED) {
            ...
            iMin = Math.min(i4, fragment.mMaxState.ordinal());
        }
        int i6 = iMin;
                    ...
                    if (i6 < 2) {
                        ...
                        if (fragment.mView != null && fragment.mContainer != null) {
                            ...
                            if (fragment.getParentFragment() == null || !fragment.getParentFragment().mRemoving) {
                                AnimationOrAnimator animationOrAnimatorLoadAnimation = (this.mCurState <= 0 || this.mDestroyed || fragment.mView.getVisibility() != 0 || fragment.mPostponedAlpha < 0.0f) ? null : loadAnimation(fragment, i2, false, i3);
                                fragment.mPostponedAlpha = 0.0f;
                                if (animationOrAnimatorLoadAnimation != null) {
                                    animateRemoveFragment(fragment, animationOrAnimatorLoadAnimation, i6);
                                }
    ...
    void completeShowHideFragment(final Fragment fragment) throws Resources.NotFoundException {
        if (fragment.mView != null) {
    ...
    void completeExecute(BackStackRecord backStackRecord, boolean z, boolean z2, boolean z3) throws Resources.NotFoundException {
        if (z) {
    ...
    void restoreSaveState(Parcelable parcelable) {
        ...
        while (it2.hasNext()) {
            ...
            if (next2 != null) {
                Fragment fragmentInstantiate = next2.instantiate(this.mHost.getContext().getClassLoader(), getFragmentFactory());
