...
public final class ActivityFilter {
    ...
    public ActivityFilter(ComponentName componentName, String str) {
        ...
        if (StringsKt.contains$default((CharSequence) str3, (CharSequence) ProxyConfig.MATCH_ALL_SCHEMES, false, 2, (Object) null) && StringsKt.indexOf$default((CharSequence) str3, ProxyConfig.MATCH_ALL_SCHEMES, 0, false, 6, (Object) null) != className.length() - 1) {
            z = false;
        }
        if (!z) {
