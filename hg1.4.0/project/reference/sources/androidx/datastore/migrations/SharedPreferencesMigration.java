    ...
    public Object shouldMigrate(T t, Continuation<? super Boolean> continuation) throws Throwable {
        ...
        if (continuation instanceof C00491) {
            ...
            if ((c00491.label & Integer.MIN_VALUE) != 0) {
                ...
                c00491 = new C00491(this, continuation);
            }
        }
        Object objInvoke = c00491.result;
        ...
        if (i == 0) {
            ...
            c00491.L$0 = this;
            c00491.label = 1;
            objInvoke = function2.invoke(t, c00491);
            ...
            sharedPreferencesMigration = (SharedPreferencesMigration) c00491.L$0;
            ResultKt.throwOnFailure(objInvoke);
        }
