...
public final class SimpleActor<T> {
    ...
    public SimpleActor(CoroutineScope scope, final Function1<? super Throwable, Unit> onComplete, final Function2<? super T, ? super Throwable, Unit> onUndeliveredElement, Function2<? super T, ? super Continuation<? super Unit>, ? extends Object> consumeMessage) {
        ...
        job.invokeOnCompletion(new Function1<Throwable, Unit>() { // from class: androidx.datastore.core.SimpleActor.1
            ...
            public final void invoke2(Throwable th) {
                ...
                do {
                    Object objM2066getOrNullimpl = ChannelResult.m2066getOrNullimpl(((SimpleActor) this).messageQueue.mo2055tryReceivePtdJZtk());
                    if (objM2066getOrNullimpl == null) {
                        unit = null;
                    } else {
                        onUndeliveredElement.invoke(objM2066getOrNullimpl, th);
                        unit = Unit.INSTANCE;
                    }
                } while (unit != null);
            }
    ...
    public final void offer(T msg) {
        Object obj = this.messageQueue.mo2056trySendJP2dKIU(msg);
        if (obj instanceof ChannelResult.Closed) {
            Throwable thM2065exceptionOrNullimpl = ChannelResult.m2065exceptionOrNullimpl(obj);
            if (thM2065exceptionOrNullimpl != null) {
                throw thM2065exceptionOrNullimpl;
            }
            throw new ClosedSendChannelException("Channel was closed normally");
        }
        if (!ChannelResult.m2071isSuccessimpl(obj)) {
    ...
    @DebugMetadata(c = "androidx.datastore.core.SimpleActor$offer$2", f = "SimpleActor.kt", i = {}, l = {IjkMediaMeta.FF_PROFILE_H264_HIGH_422, IjkMediaMeta.FF_PROFILE_H264_HIGH_422}, m = "invokeSuspend", n = {}, s = {})
