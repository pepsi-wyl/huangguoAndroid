...
public abstract class MediaCodecRenderer extends BaseRenderer {
    ...
    protected final void maybeInitCodecOrBypass() throws MediaCryptoException, ExoPlaybackException {
        Format format;
    ...
    */
    ...
    @Override // androidx.media3.exoplayer.BaseRenderer, androidx.media3.exoplayer.Renderer
    public void setPlaybackSpeed(float f, float f2) throws MediaCryptoException, ExoPlaybackException {
    ...
    public void render(long j, long j2) throws MediaCryptoException, ExoPlaybackException, NumberFormatException {
        boolean z = false;
    ...
    protected MediaCodecDecoderException createDecoderException(Throwable th, MediaCodecInfo mediaCodecInfo) throws NumberFormatException {
    ...
    private boolean initMediaCryptoIfDrmSessionReady() throws MediaCryptoException, ExoPlaybackException {
    ...
    private void initCodec(MediaCodecInfo mediaCodecInfo, MediaCrypto mediaCrypto) throws Exception {
        ...
        float codecOperatingRateV23 = i < 23 ? CODEC_OPERATING_RATE_UNSET : getCodecOperatingRateV23(this.targetPlaybackSpeed, format, getStreamFormats());
    ...
    */
    ...
    private boolean updateCodecOperatingRate(Format format) throws MediaCryptoException, ExoPlaybackException {
    ...
    private void drainAndReinitializeCodec() throws MediaCryptoException, ExoPlaybackException {
        if (this.codecReceivedBuffers) {
            this.codecDrainState = 1;
            this.codecDrainAction = 3;
        } else {
    ...
    private void reinitializeCodec() throws MediaCryptoException, ExoPlaybackException {
        releaseCodec();
        maybeInitCodecOrBypass();
    }
    ...
    private boolean bypassRender(long j, long j2) throws MediaCryptoException, ExoPlaybackException {
