...
public final class SsMediaSource extends BaseMediaSource implements Loader.Callback<ParsingLoadable<SsManifest>> {
    ...
    private void processManifest() {
        ...
        if (jMax2 == Long.MAX_VALUE) {
            singlePeriodTimeline = new SinglePeriodTimeline(this.manifest.isLive ? -9223372036854775807L : 0L, 0L, 0L, 0L, true, this.manifest.isLive, this.manifest.isLive, (Object) this.manifest, getMediaItem());
            ...
            singlePeriodTimeline = new SinglePeriodTimeline(C.TIME_UNSET, j2, j, jMsToUs, true, true, true, (Object) this.manifest, getMediaItem());
        } else {
            long j3 = this.manifest.durationUs != C.TIME_UNSET ? this.manifest.durationUs : jMax - jMax2;
            singlePeriodTimeline = new SinglePeriodTimeline(jMax2 + j3, j3, jMax2, 0L, true, false, false, (Object) this.manifest, getMediaItem());
        }
