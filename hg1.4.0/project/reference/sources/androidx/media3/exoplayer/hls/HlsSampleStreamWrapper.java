...
final class HlsSampleStreamWrapper implements Loader.Callback<Chunk>, Loader.ReleaseCallback, SequenceableLoader, ExtractorOutput, SampleQueue.UpstreamFormatChangedListener {
    ...
    */
        ...
        for (int i4 = 0; i4 < exoTrackSelectionArr.length; i4++) {
            ...
            if (exoTrackSelection2 != null) {
                ...
                if (sampleStreamArr[i4] == null) {
                    this.enabledTrackGroupCount++;
                    sampleStreamArr[i4] = new HlsSampleStream(this, iIndexOf);
                    zArr2[i4] = true;
    ...
    public void onPlaylistUpdated() {
        ...
        if (chunkPublicationState == 0) {
            this.handler.post(new Runnable() { // from class: androidx.media3.exoplayer.hls.HlsSampleStreamWrapper$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.m255x332ef84d(hlsMediaChunk);
                }
            });
    ...
    /* synthetic */ void m255x332ef84d(HlsMediaChunk hlsMediaChunk) {
    ...
    public int readData(int i, FormatHolder formatHolder, DecoderInputBuffer decoderInputBuffer, int i2) {
        ...
        if (i5 == -5) {
            ...
            if (i == this.primarySampleQueueIndex) {
                ...
                while (i3 < this.mediaChunks.size() && this.mediaChunks.get(i3).uid != iCheckedCast) {
                    i3++;
                }
    ...
    private static Format deriveFormat(Format format, Format format2, boolean z) {
        ...
        if (format.metadata != null) {
            ...
            if (format2.metadata != null) {
                metadataCopyWithAppendedEntriesFrom = format2.metadata.copyWithAppendedEntriesFrom(metadataCopyWithAppendedEntriesFrom);
            }
