    ...
    */
    public SeekMap.SeekPoints getSeekPoints(long j, int i) {
        ...
        if (i2 != -1) {
            ...
            return new SeekMap.SeekPoints(seekPoint, new SeekPoint(j3, jMaybeAdjustSeekOffset2));
        }
    ...
    private void processMoovAtom(Atom.ContainerAtom containerAtom) throws ParserException {
        ...
        long j = C.TIME_UNSET;
        List<TrackSampleTable> traks = AtomParsers.parseTraks(containerAtom, gaplessInfoHolder, C.TIME_UNSET, null, z2, z, function);
