...
public final class Mp3Extractor implements Extractor {
    ...
    private Seeker getConstantBitrateSeeker(long j, XingFrame xingFrame, long j2) {
        ...
        long j6 = j3;
        return new ConstantBitrateSeeker(j4, j + xingFrame.header.frameSize, Ints.checkedCast(Util.scaleLargeValue(j6, 8000000L, jComputeDurationUs, RoundingMode.HALF_UP)), Ints.checkedCast(LongMath.divide(j6, xingFrame.frameCount, RoundingMode.HALF_UP)), false);
    }
