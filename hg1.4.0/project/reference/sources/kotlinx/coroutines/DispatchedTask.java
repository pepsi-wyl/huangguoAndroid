...
public abstract class DispatchedTask<T> extends Task {
    ...
    */
    public final void run() {
        ...
        Object objM497constructorimpl2;
        ...
        try {
            ...
            try {
                ...
                if (job != null && !job.isActive()) {
                    ...
                    continuation.resumeWith(Result.m497constructorimpl(ResultKt.createFailure(cancellationExceptionRecoverFromStackFrame)));
                } else if (exceptionalResult$kotlinx_coroutines_core != null) {
                    Result.Companion companion2 = Result.INSTANCE;
                    continuation.resumeWith(Result.m497constructorimpl(ResultKt.createFailure(exceptionalResult$kotlinx_coroutines_core)));
                } else {
                    Result.Companion companion3 = Result.INSTANCE;
                    continuation.resumeWith(Result.m497constructorimpl(getSuccessfulResult$kotlinx_coroutines_core(objTakeState$kotlinx_coroutines_core)));
                }
                ...
                try {
                    ...
                    objM497constructorimpl2 = Result.m497constructorimpl(Unit.INSTANCE);
                } catch (Throwable th) {
                    Result.Companion companion5 = Result.INSTANCE;
                    objM497constructorimpl2 = Result.m497constructorimpl(ResultKt.createFailure(th));
                }
                handleFatalException(null, Result.m500exceptionOrNullimpl(objM497constructorimpl2));
            } finally {
            ...
            try {
                ...
                taskContext.afterTask();
                objM497constructorimpl = Result.m497constructorimpl(Unit.INSTANCE);
            } catch (Throwable th3) {
                Result.Companion companion7 = Result.INSTANCE;
                objM497constructorimpl = Result.m497constructorimpl(ResultKt.createFailure(th3));
            }
            handleFatalException(th2, Result.m500exceptionOrNullimpl(objM497constructorimpl));
        }
    }
