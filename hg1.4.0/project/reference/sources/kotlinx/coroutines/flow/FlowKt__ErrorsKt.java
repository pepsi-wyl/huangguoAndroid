...
final /* synthetic */ class FlowKt__ErrorsKt {
    ...
    static final class C01571 extends SuspendLambda implements Function2<Throwable, Continuation<? super Boolean>, Object> {
        int label;
        ...
        public final Object invoke(Throwable th, Continuation<? super Boolean> continuation) {
            return ((C01571) create(th, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    static final class AnonymousClass2<T> implements FlowCollector {
        ...
        */
        public final Object emit(T t, Continuation<? super Unit> continuation) throws Throwable {
            ...
            public static final <T> Flow<T> m2087catch(Flow<? extends T> flow, Function3<? super FlowCollector<? super T>, ? super Throwable, ? super Continuation<? super Unit>, ? extends Object> function3) {
