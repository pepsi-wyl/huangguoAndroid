...
final /* synthetic */ class FlowKt__ReduceKt {
    ...
    */
    public static final <S, T extends S> Object reduce(Flow<? extends T> flow, Function3<? super S, ? super T, ? super Continuation<? super S>, ? extends Object> function3, Continuation<? super S> continuation) throws Throwable {
        ...
        if (i == 0) {
            ...
            FlowCollector<? super Object> c01702 = new C01702<>(objectRef2, function3);
            c01691.L$0 = objectRef2;
            c01691.label = 1;
            if (flow.collect(c01702, c01691) == coroutine_suspended) {
            ...
            objectRef = (Ref.ObjectRef) c01691.L$0;
            ResultKt.throwOnFailure(obj);
        }
    ...
    */
    public static final <T, R> Object fold(Flow<? extends T> flow, R r, Function3<? super R, ? super T, ? super Continuation<? super R>, ? extends Object> function3, Continuation<? super R> continuation) throws Throwable {
        ...
        if (i == 0) {
            ...
            c01641.label = 1;
            if (flow.collect(anonymousClass2, c01641) == coroutine_suspended) {
                return coroutine_suspended;
            }
            objectRef = objectRef2;
        } else {
    ...
    */
    public static final <T> Object single(Flow<? extends T> flow, Continuation<? super T> continuation) throws Throwable {
        ...
        if (i == 0) {
            ...
            c01711.L$0 = objectRef2;
            c01711.label = 1;
            if (flow.collect(flowCollector, c01711) == coroutine_suspended) {
                return coroutine_suspended;
            }
            objectRef = objectRef2;
        } else {
            ...
            objectRef = (Ref.ObjectRef) c01711.L$0;
            ResultKt.throwOnFailure(obj);
        }
        if (objectRef.element == NullSurrogateKt.NULL) {
    ...
    */
    public static final <T> Object singleOrNull(Flow<? extends T> flow, Continuation<? super T> continuation) throws Throwable {
        ...
        if (i == 0) {
            ...
            try {
                c01731.L$0 = objectRef2;
                c01731.L$1 = flowCollector2;
                c01731.label = 1;
                if (flow.collect(flowCollector2, c01731) == coroutine_suspended) {
                    return coroutine_suspended;
                }
                objectRef = objectRef2;
            ...
            flowCollector = (FlowKt__ReduceKt$singleOrNull$$inlined$collectWhile$1) c01731.L$1;
            objectRef = (Ref.ObjectRef) c01731.L$0;
            try {
                ResultKt.throwOnFailure(obj);
    ...
    */
    public static final <T> Object firstOrNull(Flow<? extends T> flow, Continuation<? super T> continuation) throws Throwable {
        ...
        if (i == 0) {
            ...
            try {
                c01621.L$0 = objectRef2;
                c01621.L$1 = flowCollector2;
                c01621.label = 1;
                if (flow.collect(flowCollector2, c01621) == coroutine_suspended) {
                    return coroutine_suspended;
                }
                objectRef = objectRef2;
            } catch (AbortFlowException e2) {
            ...
            flowCollector = (FlowKt__ReduceKt$firstOrNull$$inlined$collectWhile$1) c01621.L$1;
            objectRef = (Ref.ObjectRef) c01621.L$0;
            try {
                ResultKt.throwOnFailure(obj);
            } catch (AbortFlowException e3) {
                e = e3;
    ...
    */
    public static final <T> Object firstOrNull(Flow<? extends T> flow, Function2<? super T, ? super Continuation<? super Boolean>, ? extends Object> function2, Continuation<? super T> continuation) throws Throwable {
        ...
        AbortFlowException e;
        FlowCollector<? super Object> flowCollector;
        if (continuation instanceof C01633) {
            c01633 = (C01633) continuation;
            if ((c01633.label & Integer.MIN_VALUE) != 0) {
                c01633.label -= Integer.MIN_VALUE;
            } else {
                c01633 = new C01633(continuation);
            }
        }
        Object obj = c01633.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i = c01633.label;
        if (i == 0) {
            ResultKt.throwOnFailure(obj);
            ...
            try {
                c01633.L$0 = objectRef2;
                c01633.L$1 = flowKt__ReduceKt$firstOrNull$$inlined$collectWhile$2;
                c01633.label = 1;
                if (flow.collect(flowKt__ReduceKt$firstOrNull$$inlined$collectWhile$2, c01633) == coroutine_suspended) {
                    return coroutine_suspended;
                }
                objectRef = objectRef2;
            } catch (AbortFlowException e2) {
            ...
            flowCollector = (FlowKt__ReduceKt$firstOrNull$$inlined$collectWhile$2) c01633.L$1;
            objectRef = (Ref.ObjectRef) c01633.L$0;
            try {
                ResultKt.throwOnFailure(obj);
            } catch (AbortFlowException e3) {
                e = e3;
    ...
    */
    public static final <T> Object lastOrNull(Flow<? extends T> flow, Continuation<? super T> continuation) throws Throwable {
        ...
        if (i == 0) {
            ...
            c01671.label = 1;
            if (flow.collect(flowCollector, c01671) == coroutine_suspended) {
                return coroutine_suspended;
            }
            objectRef = objectRef2;
        } else {
