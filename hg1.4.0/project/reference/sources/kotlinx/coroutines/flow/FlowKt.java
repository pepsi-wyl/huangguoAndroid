...
public final class FlowKt {
    ...
    public static final <T> Flow<T> m2080catch(Flow<? extends T> flow, Function3<? super FlowCollector<? super T>, ? super Throwable, ? super Continuation<? super Unit>, ? extends Object> function3) {
        return FlowKt__ErrorsKt.m2087catch(flow, function3);
    }
    ...
    public static final <T> Flow<T> m2081debounceHG0u8IE(Flow<? extends T> flow, long j) {
        return FlowKt__DelayKt.m2083debounceHG0u8IE(flow, j);
    }
    ...
    public static final <T> Flow<T> m2082sampleHG0u8IE(Flow<? extends T> flow, long j) {
        return FlowKt__DelayKt.m2084sampleHG0u8IE(flow, j);
    }
