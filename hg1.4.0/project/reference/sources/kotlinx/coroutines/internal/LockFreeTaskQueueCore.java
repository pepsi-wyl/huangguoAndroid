...
public final class LockFreeTaskQueueCore<E> {
    ...
    public final <R> List<R> map(Function1<? super E, ? extends R> transform) {
        ...
        while (true) {
            int i3 = this.mask;
            if ((i & i3) != (i2 & i3)) {
                WakelockPlusApi$Companion$codec$2 wakelockPlusApi$Companion$codec$2 = (Object) this.array.get(i3 & i);
                if (wakelockPlusApi$Companion$codec$2 != null && !(wakelockPlusApi$Companion$codec$2 instanceof Placeholder)) {
                    arrayList.add(transform.invoke(wakelockPlusApi$Companion$codec$2));
                }
                i++;
            } else {
                return arrayList;
    ...
    public final int addLast(E element) {
        while (true) {
            ...
            if (!this.singleConsumer && this.array.get(i2 & i3) != null) {
                ...
                while ((lockFreeTaskQueueCoreFillPlaceholder._state & FROZEN_MASK) != 0 && (lockFreeTaskQueueCoreFillPlaceholder = lockFreeTaskQueueCoreFillPlaceholder.next().fillPlaceholder(i2, element)) != null) {
                }
                return 0;
            }
        }
