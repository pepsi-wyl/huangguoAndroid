...
public final class LimitedDispatcher extends CoroutineDispatcher implements Runnable, Delay {
    ...
    public void mo2103scheduleResumeAfterDelay(long timeMillis, CancellableContinuation<? super Unit> continuation) {
        this.$$delegate_0.mo2103scheduleResumeAfterDelay(timeMillis, continuation);
    }
    ...
    */
            ...
            while (true) {
                ...
                if (i >= 16) {
                    ...
                    if (this.dispatcher.isDispatchNeeded(limitedDispatcher)) {
                        this.dispatcher.mo2102dispatch(limitedDispatcher, this);
                        return;
                    }
                }
            }
    ...
    public void mo2102dispatch(CoroutineContext context, Runnable block) {
        ...
        this.dispatcher.mo2102dispatch(this, this);
    }
