    ...
    */
    public final Object yieldFrames(SequenceScope<? super StackTraceElement> sequenceScope, CoroutineStackFrame coroutineStackFrame, Continuation<? super Unit> continuation) throws Throwable {
        ...
        if (i == 0) {
            ...
            CoroutineStackFrame coroutineStackFrame2 = (CoroutineStackFrame) c01541.L$2;
            SequenceScope<? super StackTraceElement> sequenceScope2 = (SequenceScope) c01541.L$1;
            debugCoroutineInfoImpl = (DebugCoroutineInfoImpl) c01541.L$0;
            ResultKt.throwOnFailure(obj);
            ...
            if (coroutineStackFrame == null) {
                ...
                if (stackTraceElement != null) {
                    c01541.L$0 = debugCoroutineInfoImpl;
                    c01541.L$1 = sequenceScope;
                    c01541.L$2 = coroutineStackFrame;
                    c01541.label = 1;
                    if (sequenceScope.yield(stackTraceElement, c01541) == coroutine_suspended) {
                        return coroutine_suspended;
                    }
