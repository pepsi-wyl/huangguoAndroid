...
public final class AgentPremain {
    ...
    static {
        ...
        try {
            ...
            objM497constructorimpl = Result.m497constructorimpl(property != null ? Boolean.valueOf(Boolean.parseBoolean(property)) : null);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM497constructorimpl = Result.m497constructorimpl(ResultKt.createFailure(th));
        }
        Boolean bool = (Boolean) (Result.m503isFailureimpl(objM497constructorimpl) ? null : objM497constructorimpl);
        ...
        try {
            Signal.handle(new Signal("TRAP"), new SignalHandler() { // from class: kotlinx.coroutines.debug.AgentPremain$$ExternalSyntheticLambda0
                public final void handle(Signal signal) {
                    AgentPremain.m2079installSignalHandler$lambda1(signal);
                }
            });
    ...
    public static final void m2079installSignalHandler$lambda1(Signal signal) {
