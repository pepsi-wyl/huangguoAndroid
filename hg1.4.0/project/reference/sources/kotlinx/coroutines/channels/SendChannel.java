...
public interface SendChannel<E> {
    ...
    Object mo2056trySendJP2dKIU(E element);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) throws Throwable {
            ...
            if (ChannelResult.m2071isSuccessimpl(objMo2056trySendJP2dKIU)) {
                return true;
            }
            Throwable thM2065exceptionOrNullimpl = ChannelResult.m2065exceptionOrNullimpl(objMo2056trySendJP2dKIU);
