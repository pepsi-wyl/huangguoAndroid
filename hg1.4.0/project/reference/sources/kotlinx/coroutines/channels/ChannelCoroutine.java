...
public class ChannelCoroutine<E> extends AbstractCoroutine<Unit> implements Channel<E> {
    ...
    public Object mo2054receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation) {
        Object obj = this._channel.mo2054receiveCatchingJP2dKIU(continuation);
    ...
    public Object mo2055tryReceivePtdJZtk() {
        return this._channel.mo2055tryReceivePtdJZtk();
    }

    @Override // kotlinx.coroutines.channels.SendChannel
    /* renamed from: trySend-JP2dKIU */
    public Object mo2056trySendJP2dKIU(E element) {
        return this._channel.mo2056trySendJP2dKIU(element);
    }
