...
public abstract class AbstractChannel<E> extends AbstractSendChannel<E> implements Channel<E> {
    ...
    */
    public final Object mo2054receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation) {
        ...
        if (i == 0) {
            ...
            if (objPollInternal != AbstractChannelKt.POLL_FAILED) {
                return objPollInternal instanceof Closed ? ChannelResult.INSTANCE.m2074closedJP2dKIU(((Closed) objPollInternal).closeCause) : ChannelResult.INSTANCE.m2076successJP2dKIU(objPollInternal);
            }
