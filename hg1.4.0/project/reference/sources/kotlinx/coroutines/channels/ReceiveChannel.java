...
public interface ReceiveChannel<E> {
    ...
    Object mo2054receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation);

    @Deprecated(level = DeprecationLevel.ERROR, message = "Deprecated in favor of 'receiveCatching'. Please note that the provided replacement does not rethrow channel's close cause as 'receiveOrNull' did, for the detailed replacement please refer to the 'receiveOrNull' documentation", replaceWith = @ReplaceWith(expression = "receiveCatching().getOrNull()", imports = {}))
    Object receiveOrNull(Continuation<? super E> continuation);

    /* renamed from: tryReceive-PtdJZtk */
    Object mo2055tryReceivePtdJZtk();
    ...
    public static final class DefaultImpls {
        ...
        public static <E> E poll(ReceiveChannel<? extends E> receiveChannel) throws Throwable {
            Object objMo2055tryReceivePtdJZtk = receiveChannel.mo2055tryReceivePtdJZtk();
            if (ChannelResult.m2071isSuccessimpl(objMo2055tryReceivePtdJZtk)) {
                return (E) ChannelResult.m2067getOrThrowimpl(objMo2055tryReceivePtdJZtk);
            }
            Throwable thM2065exceptionOrNullimpl = ChannelResult.m2065exceptionOrNullimpl(objMo2055tryReceivePtdJZtk);
            if (thM2065exceptionOrNullimpl == null) {
                return null;
            }
            throw StackTraceRecoveryKt.recoverStackTrace(thM2065exceptionOrNullimpl);
        }
        ...
        */
        public static <E> Object receiveOrNull(ReceiveChannel<? extends E> receiveChannel, Continuation<? super E> continuation) throws Throwable {
            ...
            if (i == 0) {
                ...
                objMo2054receiveCatchingJP2dKIU = receiveChannel.mo2054receiveCatchingJP2dKIU(anonymousClass1);
            ...
            return ChannelResult.m2066getOrNullimpl(objMo2054receiveCatchingJP2dKIU);
        }
