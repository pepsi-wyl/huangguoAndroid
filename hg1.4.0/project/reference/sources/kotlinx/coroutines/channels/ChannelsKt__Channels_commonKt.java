    ...
    public static final <E> Object toList(ReceiveChannel<? extends E> receiveChannel, Continuation<? super List<? extends E>> continuation) throws Throwable {
        ...
        if (i == 0) {
            ...
            try {
                ...
                c01161.L$0 = list;
                c01161.L$1 = list2;
                c01161.L$2 = receiveChannel2;
                c01161.L$3 = it;
                c01161.label = 1;
                objHasNext = it.hasNext(c01161);
                if (objHasNext != coroutine_suspended) {
                }
            } catch (Throwable th2) {
                receiveChannel2 = receiveChannel;
            ...
            it = (ChannelIterator) c01161.L$3;
            ReceiveChannel<? extends E> receiveChannel3 = (ReceiveChannel) c01161.L$2;
            List list3 = (List) c01161.L$1;
            list = (List) c01161.L$0;
            try {
                ResultKt.throwOnFailure(obj);
                List list4 = list3;
                if (!((Boolean) obj).booleanValue()) {
