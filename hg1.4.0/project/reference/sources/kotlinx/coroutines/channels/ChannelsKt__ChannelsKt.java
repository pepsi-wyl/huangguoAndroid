...
final /* synthetic */ class ChannelsKt__ChannelsKt {
    ...
    static final class AnonymousClass2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super ChannelResult<? extends Unit>>, Object> {
        ...
        public final Object invokeSuspend(Object obj) throws Throwable {
            ...
            return ChannelResult.m2061boximpl(Result.m504isSuccessimpl(objM497constructorimpl) ? ChannelResult.INSTANCE.m2076successJP2dKIU(Unit.INSTANCE) : ChannelResult.INSTANCE.m2074closedJP2dKIU(Result.m500exceptionOrNullimpl(objM497constructorimpl)));
        }
    }

    /* JADX WARN: Multi-variable type inference failed */
    public static final <E> Object trySendBlocking(SendChannel<? super E> sendChannel, E e) {
        Object objMo2056trySendJP2dKIU = sendChannel.mo2056trySendJP2dKIU(e);
        if (objMo2056trySendJP2dKIU instanceof ChannelResult.Failed) {
    ...
    public static final <E> void sendBlocking(SendChannel<? super E> sendChannel, E e) {
        if (ChannelResult.m2071isSuccessimpl(sendChannel.mo2056trySendJP2dKIU(e))) {
            return;
        }
