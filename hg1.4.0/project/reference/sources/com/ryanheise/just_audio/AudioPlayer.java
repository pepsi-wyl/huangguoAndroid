...
public class AudioPlayer implements MethodChannel.MethodCallHandler, Player.Listener, MetadataOutput {
    ...
    */
    public void onMethodCall(MethodCall methodCall, final MethodChannel.Result result) throws IllegalStateException, UnsupportedOperationException, IllegalArgumentException {
        char c;
                ...
                try {
                    ...
                    switch (c) {
                        case 0:
                            ...
                            load(getAudioSource(methodCall.argument("audioSource")), l == null ? C.TIME_UNSET : l.longValue() / 1000, (Integer) methodCall.argument("initialIndex"), result);
                            break;
                        case 1:
                            play(result);
                            break;
                        case 2:
                            ...
                            break;
                        case 3:
                            setVolume((float) ((Double) methodCall.argument(MethodArg.VOLUME)).doubleValue());
                            result.success(new HashMap());
                            break;
                        case 4:
                        ...
                        case '\r':
                            ...
                            seek(l2 == null ? C.TIME_UNSET : l2.longValue() / 1000, (Integer) methodCall.argument("index"), result);
                            break;
                        case 14:
                            concatenating(methodCall.argument(TtmlNode.ATTR_ID)).addMediaSources(((Integer) methodCall.argument("index")).intValue(), getAudioSources(methodCall.argument("children")), this.handler, new Runnable() { // from class: com.ryanheise.just_audio.AudioPlayer$$ExternalSyntheticLambda0
                                @Override // java.lang.Runnable
                                public final void run() {
                                    result.success(new HashMap());
                                }
                            });
                            concatenating(methodCall.argument(TtmlNode.ATTR_ID)).setShuffleOrder(decodeShuffleOrder((List) methodCall.argument("shuffleOrder")));
                            break;
                        case 15:
                            concatenating(methodCall.argument(TtmlNode.ATTR_ID)).removeMediaSourceRange(((Integer) methodCall.argument(SpellCheckPlugin.START_INDEX_KEY)).intValue(), ((Integer) methodCall.argument(SpellCheckPlugin.END_INDEX_KEY)).intValue(), this.handler, new Runnable() { // from class: com.ryanheise.just_audio.AudioPlayer$$ExternalSyntheticLambda1
                                @Override // java.lang.Runnable
                                public final void run() {
                                    result.success(new HashMap());
                                }
                            ...
                            break;
                        case 16:
                            concatenating(methodCall.argument(TtmlNode.ATTR_ID)).moveMediaSource(((Integer) methodCall.argument("currentIndex")).intValue(), ((Integer) methodCall.argument("newIndex")).intValue(), this.handler, new Runnable() { // from class: com.ryanheise.just_audio.AudioPlayer$$ExternalSyntheticLambda2
                                @Override // java.lang.Runnable
                                public final void run() {
                                    result.success(new HashMap());
                                }
