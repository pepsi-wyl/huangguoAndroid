...
final class MacHashFunction extends AbstractHashFunction {
    ...
    MacHashFunction(String algorithmName, Key key, String toString) throws NoSuchAlgorithmException, InvalidKeyException {
    ...
    private static Mac getMac(String algorithmName, Key key) throws NoSuchAlgorithmException, InvalidKeyException {
        try {
    ...
    private static final class MacHasher extends AbstractByteHasher {
        ...
        protected void update(byte b) throws IllegalStateException {
            checkNotDone();
            this.mac.update(b);
        }
        ...
        @Override // com.google.common.hash.AbstractByteHasher
        protected void update(byte[] b, int off, int len) throws IllegalStateException {
            checkNotDone();
