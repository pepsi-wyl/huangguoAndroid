...
final class AdjustedTimeMark implements TimeMark {
    ...
    public TimeMark mo1867minusLRDsOJo(long j) {
        return TimeMark.DefaultImpls.m2013minusLRDsOJo(this, j);
    }

    @Override // kotlin.time.TimeMark
    /* renamed from: elapsedNow-UwyO8pc */
    public long mo1866elapsedNowUwyO8pc() {
        return Duration.m1911minusLRDsOJo(this.mark.mo1866elapsedNowUwyO8pc(), this.adjustment);
    }

    @Override // kotlin.time.TimeMark
    /* renamed from: plus-LRDsOJo */
    public TimeMark mo1869plusLRDsOJo(long duration) {
        return new AdjustedTimeMark(this.mark, Duration.m1912plusLRDsOJo(this.adjustment, duration), null);
    }
}
