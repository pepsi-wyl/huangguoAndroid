...
public interface TimeMark {
    ...
    TimeMark mo1867minusLRDsOJo(long duration);

    /* renamed from: plus-LRDsOJo */
    TimeMark mo1869plusLRDsOJo(long duration);

    /* compiled from: TimeSource.kt */
    @Metadata(k = 3, mv = {1, 9, 0}, xi = 48)
    public static final class DefaultImpls {
        /* renamed from: plus-LRDsOJo, reason: not valid java name */
        public static TimeMark m2014plusLRDsOJo(TimeMark timeMark, long j) {
            return new AdjustedTimeMark(timeMark, j, null);
        }

        /* renamed from: minus-LRDsOJo, reason: not valid java name */
        public static TimeMark m2013minusLRDsOJo(TimeMark timeMark, long j) {
            return timeMark.mo1869plusLRDsOJo(Duration.m1929unaryMinusUwyO8pc(j));
        }

        public static boolean hasPassedNow(TimeMark timeMark) {
            return !Duration.m1909isNegativeimpl(timeMark.mo1866elapsedNowUwyO8pc());
        }
