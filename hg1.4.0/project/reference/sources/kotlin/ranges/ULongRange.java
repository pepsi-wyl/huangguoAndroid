...
public final class ULongRange extends ULongProgression implements ClosedRange<ULong>, OpenEndRange<ULong> {
    ...
    public static /* synthetic */ void m1781getEndExclusivesVKNKU$annotations() {
    }

    @Override // kotlin.ranges.ClosedRange
    public /* bridge */ /* synthetic */ boolean contains(Comparable comparable) {
        return m1782containsVKZWuLQ(((ULong) comparable).getData());
    }

    @Override // kotlin.ranges.OpenEndRange
    public /* bridge */ /* synthetic */ Comparable getEndExclusive() {
        return ULong.m666boximpl(m1783getEndExclusivesVKNKU());
    }

    @Override // kotlin.ranges.ClosedRange
    public /* bridge */ /* synthetic */ Comparable getEndInclusive() {
        return ULong.m666boximpl(m1784getEndInclusivesVKNKU());
    }

    @Override // kotlin.ranges.ClosedRange
    public /* bridge */ /* synthetic */ Comparable getStart() {
        return ULong.m666boximpl(m1785getStartsVKNKU());
    }
    ...
    public long m1785getStartsVKNKU() {
        return getFirst();
    }

    /* renamed from: getEndInclusive-s-VKNKU, reason: not valid java name */
    public long m1784getEndInclusivesVKNKU() {
        return getLast();
    }

    /* renamed from: getEndExclusive-s-VKNKU, reason: not valid java name */
    public long m1783getEndExclusivesVKNKU() {
        if (getLast() == -1) {
            throw new IllegalStateException("Cannot return the exclusive upper bound of a range that includes MAX_VALUE.".toString());
        }
        return ULong.m672constructorimpl(getLast() + ULong.m672constructorimpl(1 & KeyboardMap.kValueMask));
    }

    /* renamed from: contains-VKZWuLQ, reason: not valid java name */
    public boolean m1782containsVKZWuLQ(long value) {
    ...
    public int hashCode() {
        ...
        return ((int) ULong.m672constructorimpl(getLast() ^ ULong.m672constructorimpl(getLast() >>> 32))) + (((int) ULong.m672constructorimpl(getFirst() ^ ULong.m672constructorimpl(getFirst() >>> 32))) * 31);
    }

    @Override // kotlin.ranges.ULongProgression
    public String toString() {
        return ((Object) ULong.m718toStringimpl(getFirst())) + ".." + ((Object) ULong.m718toStringimpl(getLast()));
    }
