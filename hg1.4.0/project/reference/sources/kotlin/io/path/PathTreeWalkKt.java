...
public final class PathTreeWalkKt {
    ...
    public static final Object keyOf(Path path, LinkOption[] linkOptionArr) {
        try {
            ...
            BasicFileAttributes attributes = Files.readAttributes(path, (Class<BasicFileAttributes>) PathTreeWalk$$ExternalSyntheticApiModelOutline0.m(), (LinkOption[]) Arrays.copyOf(linkOptionArr2, linkOptionArr2.length));
