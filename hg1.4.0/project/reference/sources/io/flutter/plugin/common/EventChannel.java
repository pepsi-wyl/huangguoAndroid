    ...
    private final class IncomingStreamRequestHandler implements BinaryMessenger.BinaryMessageHandler {
        ...
        private void onListen(Object obj, BinaryMessenger.BinaryReply binaryReply) {
            ...
            try {
                ...
                binaryReply.reply(EventChannel.this.codec.encodeErrorEnvelope(IjkMediaPlayer.OnNativeInvokeListener.ARG_ERROR, e2.getMessage(), null));
            }
        }

        private void onCancel(Object obj, BinaryMessenger.BinaryReply binaryReply) {
            if (this.activeSink.getAndSet(null) == null) {
                binaryReply.reply(EventChannel.this.codec.encodeErrorEnvelope(IjkMediaPlayer.OnNativeInvokeListener.ARG_ERROR, "No active stream to cancel", null));
                return;
            }
            try {
                ...
                binaryReply.reply(EventChannel.this.codec.encodeErrorEnvelope(IjkMediaPlayer.OnNativeInvokeListener.ARG_ERROR, e.getMessage(), null));
            }
        }
