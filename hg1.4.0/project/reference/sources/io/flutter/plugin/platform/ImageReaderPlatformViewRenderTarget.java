...
public class ImageReaderPlatformViewRenderTarget implements PlatformViewRenderTarget {
    ...
    protected ImageReader createImageReader33() {
        d$$ExternalSyntheticApiModelOutline0.m443m();
        ImageReader.Builder builderM = d$$ExternalSyntheticApiModelOutline0.m(this.bufferWidth, this.bufferHeight);
        builderM.setMaxImages(4);
        builderM.setImageFormat(34);
        builderM.setUsage(256L);
        ImageReader imageReaderBuild = builderM.build();
