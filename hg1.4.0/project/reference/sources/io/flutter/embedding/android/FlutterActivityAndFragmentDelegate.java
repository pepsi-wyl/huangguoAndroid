...
class FlutterActivityAndFragmentDelegate implements ExclusiveAppComponent<Activity> {
    ...
    View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle, int i, boolean z) {
    ...
    void startBackGesture(BackEvent backEvent) {
        ensureAlive();
        if (this.flutterEngine != null) {
    ...
    void updateBackGestureProgress(BackEvent backEvent) {
        ensureAlive();
        if (this.flutterEngine != null) {
