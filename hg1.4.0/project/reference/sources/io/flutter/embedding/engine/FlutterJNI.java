...
public class FlutterJNI {
    ...
    public static Bitmap decodeImage(ByteBuffer byteBuffer, final long j) {
        if (Build.VERSION.SDK_INT >= 28) {
            try {
                return ImageDecoder.decodeBitmap(ImageDecoder.createSource(byteBuffer), new ImageDecoder.OnHeaderDecodedListener() { // from class: io.flutter.embedding.engine.FlutterJNI$$ExternalSyntheticLambda4
    ...
    public String[] computePlatformResolvedLocale(String[] strArr) {
        ...
        if (localeResolveNativeLocale == null) {
            return new String[0];
        }
        return new String[]{localeResolveNativeLocale.getLanguage(), localeResolveNativeLocale.getCountry(), localeResolveNativeLocale.getScript()};
    }
