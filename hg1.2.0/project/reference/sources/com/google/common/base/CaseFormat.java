    ...
    String convert(CaseFormat format, String s) {
        ...
        while (true) {
            ...
            if (length == 0) {
                ...
                ((StringBuilder) java.util.Objects.requireNonNull(sb)).append(format.normalizeWord(s.substring(length, iIndexIn)));
            }
        ...
        sb2.append(format.normalizeWord(s.substring(length)));
        return sb2.toString();
    }
