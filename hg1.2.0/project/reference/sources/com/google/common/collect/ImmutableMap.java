    ...
    public static class Builder<K, V> {
        ...
        static <V> void sortEntries(Object[] alternatingKeysAndValues, int size, Comparator<? super V> valueComparator) {
            ...
            for (int i = 0; i < size; i++) {
                int i2 = i * 2;
                entryArr[i] = new AbstractMap.SimpleImmutableEntry(Objects.requireNonNull(alternatingKeysAndValues[i2]), Objects.requireNonNull(alternatingKeysAndValues[i2 + 1]));
            }
        ...
        private Object[] lastEntryForEachKey(Object[] localAlternatingKeysAndValues, int size) {
            ...
            while (i2 < size * 2) {
                if (bitSet.get(i2 >>> 1)) {
                    ...
                    int i4 = i3 + 1;
                    int i5 = i2 + 1;
                    objArr[i3] = Objects.requireNonNull(localAlternatingKeysAndValues[i2]);
                    i3 += 2;
                    i2 += 2;
