...
public final class DelayKt {
    ...
    */
    ...
    public static final Object delay(long j, Continuation<? super Unit> continuation) {
        ...
        if (j < Long.MAX_VALUE) {
            getDelay(cancellableContinuationImpl2.getContext()).mo2103scheduleResumeAfterDelay(j, cancellableContinuationImpl2);
        }
    ...
    public static final Object m2040delayVtjQ1oo(long j, Continuation<? super Unit> continuation) {
        Object objDelay = delay(m2041toDelayMillisLRDsOJo(j), continuation);
    ...
    public static final long m2041toDelayMillisLRDsOJo(long j) {
        if (Duration.m1875compareToLRDsOJo(j, Duration.INSTANCE.m1979getZEROUwyO8pc()) > 0) {
            return RangesKt.coerceAtLeast(Duration.m1894getInWholeMillisecondsimpl(j), 1L);
        }
        return 0L;
    }
}
