...
public enum CoroutineStart {
    ...
    public final <R, T> void invoke(Function2<? super R, ? super Continuation<? super T>, ? extends Object> block, R receiver, Continuation<? super T> completion) throws Throwable {
        int i = WhenMappings.$EnumSwitchMapping$0[ordinal()];
        if (i == 1) {
