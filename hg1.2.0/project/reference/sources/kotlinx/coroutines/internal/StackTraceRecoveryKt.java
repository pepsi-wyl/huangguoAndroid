...
public final class StackTraceRecoveryKt {
    ...
    static {
        ...
        try {
            ...
            objM497constructorimpl = Result.m497constructorimpl(Class.forName(baseContinuationImplClass).getCanonicalName());
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM497constructorimpl = Result.m497constructorimpl(ResultKt.createFailure(th));
        }
        if (Result.m500exceptionOrNullimpl(objM497constructorimpl) == null) {
            obj2 = objM497constructorimpl;
        }
        baseContinuationImplClassName = (String) obj2;
        try {
            Result.Companion companion3 = Result.INSTANCE;
            objM497constructorimpl2 = Result.m497constructorimpl(Class.forName(stackTraceRecoveryClass).getCanonicalName());
        } catch (Throwable th2) {
            Result.Companion companion4 = Result.INSTANCE;
            objM497constructorimpl2 = Result.m497constructorimpl(ResultKt.createFailure(th2));
        }
        if (Result.m500exceptionOrNullimpl(objM497constructorimpl2) == null) {
            obj = objM497constructorimpl2;
        }
