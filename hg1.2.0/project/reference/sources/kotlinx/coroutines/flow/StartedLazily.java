    ...
    static final class AnonymousClass1 extends SuspendLambda implements Function2<FlowCollector<? super SharingCommand>, Continuation<? super Unit>, Object> {
        ...
        public final Object invokeSuspend(Object obj) throws Throwable {
            ...
            if (i == 0) {
                ...
                this.label = 1;
                if (this.$subscriptionCount.collect(new C00281(booleanRef, flowCollector), this) == coroutine_suspended) {
        ...
        static final class C00281<T> implements FlowCollector {
            ...
            C00281(Ref.BooleanRef booleanRef, FlowCollector<? super SharingCommand> flowCollector) {
