...
public final class StateFlowKt {
    ...
    public static final <T> T updateAndGet(MutableStateFlow<T> mutableStateFlow, Function1<? super T, ? extends T> function1) {
        WakelockPlusFlutterError wakelockPlusFlutterError;
        T tInvoke;
        do {
            wakelockPlusFlutterError = (Object) mutableStateFlow.getValue();
            tInvoke = function1.invoke(wakelockPlusFlutterError);
        } while (!mutableStateFlow.compareAndSet(wakelockPlusFlutterError, tInvoke));
        return tInvoke;
    }
    ...
    public static final <T> void update(MutableStateFlow<T> mutableStateFlow, Function1<? super T, ? extends T> function1) {
        ...
        do {
            wakelockPlusFlutterError = (Object) mutableStateFlow.getValue();
        } while (!mutableStateFlow.compareAndSet(wakelockPlusFlutterError, function1.invoke(wakelockPlusFlutterError)));
    }
