...
public class FlutterView extends FrameLayout implements MouseCursorPlugin.MouseCursorViewDelegate, KeyboardManager.ViewDelegate {
    ...
    public final WindowInsets onApplyWindowInsets(WindowInsets windowInsets) {
        ...
        if (Build.VERSION.SDK_INT >= 30) {
            int iNavigationBars = z2 ? WindowInsets.Type.navigationBars() : 0;
            if (z) {
    ...
    public View findViewByAccessibilityIdTraversal(int i) throws NoSuchMethodException, SecurityException {
        if (Build.VERSION.SDK_INT < 29) {
    ...
    private View findViewByAccessibilityIdRootedAtCurrentView(int i, View view) throws NoSuchMethodException, SecurityException {
        int i2;
    ...
    */
    void sendUserSettingsToFlutter() {
        ...
        L15:
            ...
            if (r1 < r4) goto L3e
            android.view.textservice.TextServicesManager r1 = r6.textServicesManager
            java.util.List r1 = com.huawei.hms.ads.identifier.d$$ExternalSyntheticApiModelOutline0.m(r1)
            java.util.stream.Stream r1 = com.huawei.hms.ads.identifier.d$$ExternalSyntheticApiModelOutline0.m(r1)
            io.flutter.embedding.android.FlutterView$$ExternalSyntheticLambda9 r4 = new io.flutter.embedding.android.FlutterView$$ExternalSyntheticLambda9
            r4.<init>()
            boolean r1 = com.huawei.hms.ads.identifier.d$$ExternalSyntheticApiModelOutline0.m(r1, r4)
            android.view.textservice.TextServicesManager r4 = r6.textServicesManager
            boolean r4 = com.huawei.hms.ads.identifier.d$$ExternalSyntheticApiModelOutline0.m446m(r4)
            if (r4 == 0) goto L40
            if (r1 == 0) goto L40
        L3e:
            r1 = 1
