                ...
                try {
                    if (str.hashCode() == -1307105544 && str.equals("activateSystemCursor")) {
                        try {
                            ...
                            result.error(IjkMediaPlayer.OnNativeInvokeListener.ARG_ERROR, "Error when setting cursors: " + e.getMessage(), null);
                        }
                    }
                } catch (Exception e2) {
                    result.error(IjkMediaPlayer.OnNativeInvokeListener.ARG_ERROR, "Unhandled error: " + e2.getMessage(), null);
                }
            }
        };
