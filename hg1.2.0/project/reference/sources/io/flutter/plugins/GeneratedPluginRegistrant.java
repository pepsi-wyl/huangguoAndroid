...
public final class GeneratedPluginRegistrant {
    ...
    public static void registerWith(FlutterEngine flutterEngine) {
        ...
        try {
            ...
            Log.e(TAG, "Error registering plugin screen_brightness_android, com.aaassseee.screen_brightness_android.ScreenBrightnessAndroidPlugin", e17);
        }
        try {
            flutterEngine.getPlugins().add(new ScreenStatePlugin());
        } catch (Exception e18) {
            Log.e(TAG, "Error registering plugin screen_state, dk.cachet.screen_state.ScreenStatePlugin", e18);
        }
        try {
        ...
        try {
            ...
            Log.e(TAG, "Error registering plugin video_player_android, io.flutter.plugins.videoplayer.VideoPlayerPlugin", e22);
        }
        try {
            flutterEngine.getPlugins().add(new VolumeControllerPlugin());
        } catch (Exception e23) {
            Log.e(TAG, "Error registering plugin volume_controller, com.kurenai7968.volume_controller.VolumeControllerPlugin", e23);
        }
        try {
