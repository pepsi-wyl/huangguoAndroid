...
public class AccessibilityBridge extends AccessibilityNodeProvider {
    ...
    private boolean shouldSetCollectionInfo(final SemanticsNode semanticsNode) {
        return semanticsNode.scrollChildren > 0 && (SemanticsNode.nullableHasAncestor(this.accessibilityFocusedSemanticsNode, new Predicate() { // from class: io.flutter.view.AccessibilityBridge$$ExternalSyntheticLambda5
        ...
        }) || !SemanticsNode.nullableHasAncestor(this.accessibilityFocusedSemanticsNode, new Predicate() { // from class: io.flutter.view.AccessibilityBridge$$ExternalSyntheticLambda4
            @Override // io.flutter.util.Predicate
            public final boolean test(Object obj) {
    ...
    public AccessibilityNodeInfo createAccessibilityNodeInfo(int i) {
        ...
        if (semanticsNode.platformViewId == -1 || !this.platformViewsAccessibilityDelegate.usesVirtualDisplay(semanticsNode.platformViewId)) {
            ...
            if (semanticsNode2 != null) {
                accessibilityNodeInfoObtainAccessibilityNodeInfo2.setFocused(semanticsNode2.id == i);
            }
            SemanticsNode semanticsNode3 = this.accessibilityFocusedSemanticsNode;
            if (semanticsNode3 != null) {
                accessibilityNodeInfoObtainAccessibilityNodeInfo2.setAccessibilityFocused(semanticsNode3.id == i);
            }
            if (semanticsNode.hasFlag(Flag.IS_TEXT_FIELD)) {
                ...
                accessibilityNodeInfoObtainAccessibilityNodeInfo2.setEditable(!semanticsNode.hasFlag(Flag.IS_READ_ONLY));
                ...
                if (!semanticsNode6.hasFlag(Flag.IS_HIDDEN)) {
                    if (semanticsNode6.platformViewId != -1) {
                        ...
                        if (!this.platformViewsAccessibilityDelegate.usesVirtualDisplay(semanticsNode6.platformViewId)) {
                            accessibilityNodeInfoObtainAccessibilityNodeInfo2.addChild(platformViewById);
                        }
                    }
    ...
    private boolean performSetText(SemanticsNode semanticsNode, int i, Bundle bundle) {
        ...
        if (bundle != null && bundle.containsKey(AccessibilityNodeInfoCompat.ACTION_ARGUMENT_SET_TEXT_CHARSEQUENCE)) {
            string = bundle.getString(AccessibilityNodeInfoCompat.ACTION_ARGUMENT_SET_TEXT_CHARSEQUENCE);
        } else {
            string = "";
        }
    ...
    void updateSemantics(ByteBuffer byteBuffer, String[] strArr, ByteBuffer[] byteBufferArr) {
        ...
        if (rootSemanticsNode != null) {
            ...
            if (Build.VERSION.SDK_INT >= 23 && ((Build.VERSION.SDK_INT < 28 || doesLayoutInDisplayCutoutModeRequireLeftInset()) && (rootWindowInsets = this.rootAccessibilityView.getRootWindowInsets()) != null)) {
        ...
        while (it3.hasNext()) {
            ...
            if (semanticsNode5.didScroll()) {
                ...
                if (semanticsNode5.scrollChildren > 0) {
                    ...
                    accessibilityEventObtainAccessibilityEvent.setToIndex((semanticsNode5.scrollIndex + i) - 1);
                }
                sendAccessibilityEvent(accessibilityEventObtainAccessibilityEvent);
            }
    ...
    static class SemanticsNode {
        ...
        public void updateRecursively(float[] fArr, Set<SemanticsNode> set, boolean z) {
            ...
            if (z) {
                ...
                float[] fArr6 = {this.left, this.top, 0.0f, 1.0f};
                transformPoint(fArr2, this.globalTransform, fArr6);
                fArr6[0] = this.right;
                fArr6[1] = this.top;
                transformPoint(fArr3, this.globalTransform, fArr6);
                fArr6[0] = this.right;
                fArr6[1] = this.bottom;
                transformPoint(fArr4, this.globalTransform, fArr6);
                fArr6[0] = this.left;
                fArr6[1] = this.bottom;
                transformPoint(fArr5, this.globalTransform, fArr6);
                if (this.globalRect == null) {
                    this.globalRect = new Rect();
                }
                this.globalRect.set(Math.round(min(fArr2[0], fArr3[0], fArr4[0], fArr5[0])), Math.round(min(fArr2[1], fArr3[1], fArr4[1], fArr5[1])), Math.round(max(fArr2[0], fArr3[0], fArr4[0], fArr5[0])), Math.round(max(fArr2[1], fArr3[1], fArr4[1], fArr5[1])));
