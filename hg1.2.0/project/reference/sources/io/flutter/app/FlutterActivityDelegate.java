...
public final class FlutterActivityDelegate implements FlutterActivityEvents, FlutterView.Provider, PluginRegistry {
    ...
    public void onCreate(Bundle bundle) {
        ...
        FlutterView flutterViewCreateFlutterView = this.viewFactory.createFlutterView(this.activity);
        this.flutterView = flutterViewCreateFlutterView;
        if (flutterViewCreateFlutterView == null) {
            FlutterView flutterView = new FlutterView(this.activity, null, this.viewFactory.createFlutterNativeView());
            this.flutterView = flutterView;
            flutterView.setLayoutParams(matchParent);
            this.activity.setContentView(this.flutterView);
            View viewCreateLaunchView = createLaunchView();
            this.launchView = viewCreateLaunchView;
            if (viewCreateLaunchView != null) {
                addLaunchView();
            }
        }
        if (loadIntent(this.activity.getIntent()) || (strFindAppBundlePath = FlutterMain.findAppBundlePath()) == null) {
            return;
        }
        runBundle(strFindAppBundlePath);
    }
