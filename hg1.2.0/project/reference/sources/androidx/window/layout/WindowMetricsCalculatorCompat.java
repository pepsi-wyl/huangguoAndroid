...
public final class WindowMetricsCalculatorCompat implements WindowMetricsCalculator {
    ...
    public WindowMetrics computeCurrentWindowMetrics(Activity activity) throws IllegalAccessException, NoSuchFieldException, IllegalArgumentException, InvocationTargetException {
        Rect rectComputeWindowBoundsIceCreamSandwich$window_release;
        Intrinsics.checkNotNullParameter(activity, "activity");
        if (Build.VERSION.SDK_INT >= 30) {
            rectComputeWindowBoundsIceCreamSandwich$window_release = ActivityCompatHelperApi30.INSTANCE.currentWindowBounds(activity);
        ...
        return new WindowMetrics(rectComputeWindowBoundsIceCreamSandwich$window_release);
    }
    ...
    public final Rect computeWindowBoundsP$window_release(Activity activity) throws IllegalAccessException, NoSuchFieldException, IllegalArgumentException, InvocationTargetException {
    ...
    private final DisplayCutout getCutoutForDisplay(Display display) throws IllegalAccessException, NoSuchFieldException, NoSuchMethodException, InstantiationException, SecurityException, IllegalArgumentException, InvocationTargetException {
        try {
            ...
            if (Trace$$ExternalSyntheticApiModelOutline0.m353m(obj)) {
                return Trace$$ExternalSyntheticApiModelOutline0.m(obj);
            }
