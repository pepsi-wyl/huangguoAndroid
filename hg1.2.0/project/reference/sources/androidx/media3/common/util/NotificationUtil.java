...
public final class NotificationUtil {
    ...
    public static void createNotificationChannel(Context context, String str, int i, int i2, int i3) {
        if (Util.SDK_INT >= 26) {
            ...
            Util$$ExternalSyntheticApiModelOutline0.m158m();
            NotificationChannel notificationChannelM = ComponentDialog$$ExternalSyntheticApiModelOutline0.m(str, context.getString(i), i3);
            if (i2 != 0) {
