...
class AsynchronousMediaCodecBufferEnqueuer implements MediaCodecBufferEnqueuer {
    ...
    public void doHandleMessage(Message message) throws MediaCodec.CryptoException {
        ...
        if (i == 1) {
            ...
            if (i == 3) {
                ...
                LifecycleKt$$ExternalSyntheticBackportWithForwarding0.m(this.pendingRuntimeException, null, new IllegalStateException(String.valueOf(message.what)));
            }
        } else {
            messageParams = (MessageParams) message.obj;
    ...
    private static void copy(CryptoInfo cryptoInfo, MediaCodec.CryptoInfo cryptoInfo2) {
        ...
        if (Util.SDK_INT >= 24) {
            FrameworkMediaDrm$$ExternalSyntheticApiModelOutline0.m242m();
            cryptoInfo2.setPattern(ExoPlayerImpl$$ExternalSyntheticApiModelOutline0.m(cryptoInfo.encryptedBlocks, cryptoInfo.clearBlocks));
        }
    }
