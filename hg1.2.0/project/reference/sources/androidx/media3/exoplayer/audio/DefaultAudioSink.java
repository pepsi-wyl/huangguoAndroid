...
public final class DefaultAudioSink implements AudioSink {
    ...
    public void configure(Format format, int i, int[] iArr) throws AudioSink.ConfigurationException {
        ...
        int i14 = (MimeTypes.AUDIO_DTS_EXPRESS.equals(format.sampleMimeType) && i13 == -1) ? 768000 : i13;
        if (i != 0) {
            bufferSizeInBytes = i;
            i5 = i3;
            i6 = iIntValue;
            ...
            int audioTrackMinBufferSize = getAudioTrackMinBufferSize(i2, iIntValue, i3);
            i5 = i3;
            i6 = iIntValue;
            int i15 = i14;
            i7 = pcmFrameSize2;
            i8 = i2;
            bufferSizeInBytes = audioTrackBufferSizeProvider.getBufferSizeInBytes(audioTrackMinBufferSize, i3, i4, pcmFrameSize2 != -1 ? pcmFrameSize2 : 1, i2, i15, z ? 8.0d : 1.0d);
        }
        this.offloadDisabledUntilNextConfiguration = false;
        Configuration configuration = new Configuration(format, pcmFrameSize, i4, i7, i8, i6, i5, bufferSizeInBytes, audioProcessingPipeline, z, z2, this.tunneling);
    ...
    private boolean initializeAudioTrack() throws AudioSink.InitializationException {
        ...
        if (Util.SDK_INT >= 24 && (audioCapabilitiesReceiver = this.audioCapabilitiesReceiver) != null) {
    ...
    */
    ...
    private void setAudioTrackPlaybackParametersV23() {
        if (isAudioTrackInitialized()) {
            try {
                this.audioTrack.setPlaybackParams(FrameworkMediaDrm$$ExternalSyntheticApiModelOutline0.m238m().allowDefaults().setSpeed(this.playbackParameters.speed).setPitch(this.playbackParameters.pitch).setAudioFallbackMode(2));
    ...
    private void handleSkippedSilence(long j) {
        ...
        this.reportSkippedSilenceHandler.postDelayed(new Runnable() { // from class: androidx.media3.exoplayer.audio.DefaultAudioSink$$ExternalSyntheticLambda15
    ...
    private void maybeStartAudioCapabilitiesReceiver() {
        ...
        AudioCapabilitiesReceiver audioCapabilitiesReceiver = new AudioCapabilitiesReceiver(this.context, new AudioCapabilitiesReceiver.Listener() { // from class: androidx.media3.exoplayer.audio.DefaultAudioSink$$ExternalSyntheticLambda16
    ...
    static /* synthetic */ void lambda$releaseAudioTrackAsync$1(AudioTrack audioTrack, final AudioSink.Listener listener, Handler handler, final AudioSink.AudioTrackConfig audioTrackConfig, ConditionVariable conditionVariable) {
        try {
            ...
            if (listener != null && handler.getLooper().getThread().isAlive()) {
                handler.post(new Runnable() { // from class: androidx.media3.exoplayer.audio.DefaultAudioSink$$ExternalSyntheticLambda14
                    @Override // java.lang.Runnable
                    public final void run() {
    ...
    static final class OnRoutingChangedListenerApi24 {
        ...
        private AudioRouting.OnRoutingChangedListener listener = new AudioRouting.OnRoutingChangedListener() { // from class: androidx.media3.exoplayer.audio.DefaultAudioSink$OnRoutingChangedListenerApi24$$ExternalSyntheticLambda4
        ...
        public void release() {
            this.audioTrack.removeOnRoutingChangedListener(FrameworkMediaDrm$$ExternalSyntheticApiModelOutline0.m(Assertions.checkNotNull(this.listener)));
            this.listener = null;
        }
    ...
    private static final class Configuration {
        ...
        private AudioTrack createAudioTrackV29(AudioAttributes audioAttributes, int i) {
            return FrameworkMediaDrm$$ExternalSyntheticApiModelOutline0.m().setAudioAttributes(getAudioTrackAttributesV21(audioAttributes, this.tunneling)).setAudioFormat(Util.getAudioFormat(this.outputSampleRate, this.outputChannelConfig, this.outputEncoding)).setTransferMode(1).setBufferSizeInBytes(this.bufferSize).setSessionId(i).setOffloadedPlayback(this.outputMode == 1).build();
        }
