...
public class ProfileInstaller {
    ...
    public static void writeProfile(Context context, Executor executor, DiagnosticsCallback diagnosticsCallback) throws PackageManager.NameNotFoundException {
    ...
    static void writeSkipFile(Context context, Executor executor, DiagnosticsCallback diagnosticsCallback) throws PackageManager.NameNotFoundException {
        try {
