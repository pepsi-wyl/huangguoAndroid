...
public final class SharedPreferencesMigration<T> implements DataMigration<T> {
    ...
    static final class C00491 extends ContinuationImpl {
        ...
        C00491(SharedPreferencesMigration<T> sharedPreferencesMigration, Continuation<? super C00491> continuation) {
            super(continuation);
    ...
    */
    public java.lang.Object shouldMigrate(T r5, kotlin.coroutines.Continuation<? super java.lang.Boolean> r6) throws java.lang.Throwable {
        /*
            r4 = this;
            boolean r0 = r6 instanceof androidx.datastore.migrations.SharedPreferencesMigration.C00491
            if (r0 == 0) goto L14
            r0 = r6
            androidx.datastore.migrations.SharedPreferencesMigration$shouldMigrate$1 r0 = (androidx.datastore.migrations.SharedPreferencesMigration.C00491) r0
            int r1 = r0.label
