...
final class MessageSchema<T> implements Schema<T> {
    ...
    */
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    int parseProto2Message(T r30, byte[] r31, int r32, int r33, int r34, androidx.datastore.preferences.protobuf.ArrayDecoders.Registers r35) throws java.io.IOException {
        /*
