...
public final class SharedPreferencesMigrationKt {
    ...
    static final class C00501 extends SuspendLambda implements Function2<Preferences, Continuation<? super Boolean>, Object> {
        final /* synthetic */ Set<String> $keysToMigrate;
        /* synthetic */ Object L$0;
        int label;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C00501(Set<String> set, Continuation<? super C00501> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C00501 c00501 = new C00501(this.$keysToMigrate, continuation);
            c00501.L$0 = obj;
            return c00501;
        }
        ...
        public final Object invoke(Preferences preferences, Continuation<? super Boolean> continuation) {
            return ((C00501) create(preferences, continuation)).invokeSuspend(Unit.INSTANCE);
        }
