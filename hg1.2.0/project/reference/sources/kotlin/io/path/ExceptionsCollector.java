    ...
    public final void collect(Exception exception) {
        ...
        if (this.collectedExceptions.size() < this.limit) {
            if (this.path != null) {
                ...
                Throwable thInitCause = PathTreeWalk$$ExternalSyntheticApiModelOutline0.m(String.valueOf(this.path)).initCause(exception);
                Intrinsics.checkNotNull(thInitCause, "null cannot be cast to non-null type java.nio.file.FileSystemException");
                exception = PathTreeWalk$$ExternalSyntheticApiModelOutline0.m1714m((Object) thInitCause);
            }
