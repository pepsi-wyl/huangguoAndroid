...
public final class DurationKt {
    ...
    private static final long m2003timesmvk6XK0(int i, long j) {
        return Duration.m1914timesUwyO8pc(j, i);
    }

    /* renamed from: times-kIfJnKk, reason: not valid java name */
    private static final long m2002timeskIfJnKk(double d, long j) {
        return Duration.m1913timesUwyO8pc(j, d);
    }
    ...
    public static final long parseDuration(String str, boolean z) {
        ...
        long jM1979getZEROUwyO8pc = Duration.INSTANCE.m1979getZEROUwyO8pc();
        ...
        if (str.charAt(length2) == 'P') {
            ...
            while (i < length) {
                if (str.charAt(i) != 'T') {
                    ...
                    i = length3 + 1;
                    DurationUnit durationUnitDurationUnitByIsoChar = DurationUnitKt.durationUnitByIsoChar(cCharAt3, z6);
                    ...
                    if (durationUnitDurationUnitByIsoChar == DurationUnit.SECONDS && iIndexOf$default > 0) {
                        ...
                        long jM1912plusLRDsOJo = Duration.m1912plusLRDsOJo(jM1979getZEROUwyO8pc, toDuration(parseOverLongIsoComponent(strSubstring2), durationUnitDurationUnitByIsoChar));
                        Intrinsics.checkNotNull(strSubstring, "null cannot be cast to non-null type java.lang.String");
                        String strSubstring3 = strSubstring.substring(iIndexOf$default);
                        Intrinsics.checkNotNullExpressionValue(strSubstring3, "substring(...)");
                        jM1979getZEROUwyO8pc = Duration.m1912plusLRDsOJo(jM1912plusLRDsOJo, toDuration(Double.parseDouble(strSubstring3), durationUnitDurationUnitByIsoChar));
                    } else {
                        jM1979getZEROUwyO8pc = Duration.m1912plusLRDsOJo(jM1979getZEROUwyO8pc, toDuration(parseOverLongIsoComponent(strSubstring), durationUnitDurationUnitByIsoChar));
                    }
                    obj2 = obj;
            ...
            if (StringsKt.regionMatches(str, length2, "Infinity", 0, Math.max(length - length2, 8), true)) {
                jM1979getZEROUwyO8pc = Duration.INSTANCE.m1977getINFINITEUwyO8pc();
            } else {
                boolean z7 = !z4;
                ...
                while (length2 < length) {
                    ...
                    if (iIndexOf$default2 > 0) {
                        ...
                        long jM1912plusLRDsOJo2 = Duration.m1912plusLRDsOJo(jM1979getZEROUwyO8pc, toDuration(Long.parseLong(strSubstring6), durationUnitDurationUnitByShortName));
                        Intrinsics.checkNotNull(strSubstring4, "null cannot be cast to non-null type java.lang.String");
                        ...
                        jM1979getZEROUwyO8pc = Duration.m1912plusLRDsOJo(jM1912plusLRDsOJo2, toDuration(Double.parseDouble(strSubstring7), durationUnitDurationUnitByShortName));
                        if (length2 < length) {
                            throw new IllegalArgumentException("Fractional component must be last");
                        }
                    } else {
                        jM1979getZEROUwyO8pc = Duration.m1912plusLRDsOJo(jM1979getZEROUwyO8pc, toDuration(Long.parseLong(strSubstring4), durationUnitDurationUnitByShortName));
                    }
        ...
        return z2 ? Duration.m1929unaryMinusUwyO8pc(jM1979getZEROUwyO8pc) : jM1979getZEROUwyO8pc;
    }
    ...
    public static final long durationOfNanos(long j) {
        return Duration.m1876constructorimpl(j << 1);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final long durationOfMillis(long j) {
        return Duration.m1876constructorimpl((j << 1) + 1);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final long durationOf(long j, int i) {
        return Duration.m1876constructorimpl((j << 1) + i);
    }
