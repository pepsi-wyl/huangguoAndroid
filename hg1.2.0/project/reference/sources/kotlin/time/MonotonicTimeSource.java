...
public final class MonotonicTimeSource implements TimeSource.WithComparableMarks {
    ...
    public /* bridge */ /* synthetic */ ComparableTimeMark markNow() {
        return TimeSource.Monotonic.ValueTimeMark.m2016boximpl(m2010markNowz9LOYto());
    }
    ...
    public long m2010markNowz9LOYto() {
        return TimeSource.Monotonic.ValueTimeMark.m2019constructorimpl(read());
    }

    /* renamed from: elapsedFrom-6eNON_k, reason: not valid java name */
    public final long m2009elapsedFrom6eNON_k(long timeMark) {
    ...
    public final long m2008differenceBetweenfRLX17w(long one, long another) {
        return LongSaturatedMathKt.saturatingOriginsDiff(one, another, DurationUnit.NANOSECONDS);
    }

    /* renamed from: adjustReading-6QKq23U, reason: not valid java name */
    public final long m2007adjustReading6QKq23U(long timeMark, long duration) {
        return TimeSource.Monotonic.ValueTimeMark.m2019constructorimpl(LongSaturatedMathKt.m2005saturatingAddNuflL3o(timeMark, DurationUnit.NANOSECONDS, duration));
    }
}
